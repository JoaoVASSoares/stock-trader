  ...
  <v-flex class="pr-3 pb-3" xs12 md6 lg4>
    ...
    <v-card>
      <v-container fill-height>
        ...
        <v-btn class="blue draken-3 white--text" @click="sellStock" :disabled="insufficientQuantity || quantity <= 0 || !Number.isInteger(quantity)">{{insufficientQuantity ? "Insuficiente" : "Vender"}}</v-btn>
      </v-container>
    </v-card>
  </v-flex>
</template>
